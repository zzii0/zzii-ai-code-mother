...
import com.nylg.zziiaicodemother.model.dto.app.*;
...
public class AppController {
    ...
    @Cacheable(
            value = "good_app_page",
            key = "T(com.nylg.zziiaicodemother.utils.CacheKeyUtils).generateKey(#appQueryRequest)",
    ...
    public void downloadAppCode(@PathVariable Long appId,
        ...
        ThrowUtils.throwIf(StrUtil.isBlank(app.getDeployKey()),
                ErrorCode.OPERATION_ERROR, "应用尚未部署，无法下载代码");
