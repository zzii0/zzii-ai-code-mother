<template>
  <div id="appEditPage" class="page-container">
    <PageHeader
      title="编辑应用信息"
      description="修改应用名称、封面等基本信息"
      show-back
      back-to="/"
    />
...
import { getCoverUrl, getStaticPreviewUrl } from '@/config/env'
...
const handleSubmit = async () => {
  ...
  try {
    ...
    if (isApiSuccess(res)) {
      ...
      message.error('修改失败：' + getApiErrorMessage(res))
    }
  } catch (error) {
